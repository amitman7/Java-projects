...
public class BTree<T extends Comparable<T>> {
    ...
    protected Deque<Deque<Object>> backStack = null;
    ...
    public BTree() { 
        this(2);
        this.backStack = new LinkedList<Deque<Object>>();
    }
    ...
    public void insert(T value) {
    	Deque stck = new LinkedList<Object>();
        if (root == null) {
            root = new Node<T>(null, maxDegree);
            root.addKey(value);
       
           //inserting the value of the new key in the last modified node to the stack
            stck.push(value);
            ...
            while (currentNode != null && !wasAdded) {
                ...
                if (currentNode.isLeaf()) {
                	...
                	///////////////////////////////////
                	int index = currentNode.getValuePosition(value);
                	stck.push(value); // pushing the value of the key added to the last modified leaf to the stack
                	//////////////////////////////////
                	wasAdded = true;
                } else {
                    int idx = currentNode.getValuePosition(value);
        ...
        backStack.push(stck);// adding the last insertion stack to the backtracking stack
        ++size;
